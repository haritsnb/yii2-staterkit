...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 font-weight-bold" id="page-heading">Manajemen Pengguna</h1>
            </div>
            <div class="col-sm-6 text-right">
                <button type="button" id="btn-toggle-trash" class="btn btn-outline-danger btn-sm mr-2">
                    <i class="fas fa-trash-alt mr-1"></i> Recycle Bin <span id="trash-badge" class="badge badge-danger ml-1">0</span>
                </button>
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-create" id="btn-add-user">
...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- 1. Card Filter Date Range Bawaan -->
        <div class="card card-outline card-primary mb-3">
            <div class="card-body p-3">
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <label class="mb-1 font-weight-bold"><i class="far fa-calendar-alt mr-1"></i> Rentang Tanggal Registrasi:</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                            </div>
                            <input type="text" class="form-control float-right font-weight-bold" id="filter-daterange" readonly style="background-color: #fff; cursor: pointer;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-3">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 mb-2 mb-md-0">
                        <span class="badge badge-warning p-2 font-weight-bold" style="font-size: 0.95rem;">
                            <i class="fas fa-check-square mr-1"></i> <span id="selected-count">0</span> Data Terpilih
                        </span>
                        <button type="button" id="btn-clear-selection" class="btn btn-link btn-sm text-danger ml-1" title="Batalkan semua pilihan">
                    ...
                    <div class="col-lg-4 col-md-4 mb-2 mb-md-0">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-light font-weight-bold text-sm">Tampilkan:</span>
                            </div>
                    ...
                    <div class="col-lg-5 col-md-4 text-md-right">
                        <div id="bulk-active-actions" style="display: none;">
                            <button type="button" id="btn-bulk-delete" class="btn btn-warning btn-sm mr-1">
                                <i class="fas fa-trash mr-1"></i> Bulk Soft-Delete
                            </button>
                            <button type="button" id="btn-bulk-force-delete" class="btn btn-danger btn-sm">
                                <i class="fas fa-skull-crossbones mr-1"></i> Bulk Destroy
                            </button>
                        </div>
                        <div id="bulk-trash-actions" style="display: none;">
                            <button type="button" id="btn-bulk-restore" class="btn btn-success btn-sm mr-1">
                                <i class="fas fa-trash-restore mr-1"></i> Bulk Restore
                            </button>
                            <button type="button" id="btn-bulk-force-delete-trash" class="btn btn-danger btn-sm">
                                <i class="fas fa-skull-crossbones mr-1"></i> Bulk Destroy
                            </button>
                        </div>
                    </div>
        ...
        <!-- 3. Tabel DataTables Server-Side -->
        <div class="card card-outline card-secondary">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title font-weight-bold" id="table-card-title">
                    <i class="fas fa-users mr-1"></i> Data Pengguna Aktif
                </h3>
            </div>
            <div class="card-body">
        ...
        <div class="modal-content shadow-lg border-0" style="border-radius: 16px; overflow: hidden;">
            ...
            <div class="modal-body p-4 bg-light">
                ...
                <div class="row">
                    ...
                    <!-- Audit Trail Log (Waktu UTC -> Waktu Lokal Klien) -->
                    <div class="col-md-6 mb-3">
                        <div class="card shadow-xs h-100 mb-0">
                            <div class="card-header bg-white py-2">
                                <h6 class="font-weight-bold mb-0 text-secondary"><i class="fas fa-history mr-1 text-info"></i> Jejak Audit (Audit Trail)</h6>
                            </div>
                            <div class="card-body p-3">
                                <ul class="list-group list-group-flush small">
                                    <li class="list-group-item px-0 py-2">
                                    ...
                                    <li class="list-group-item px-0 py-2" id="detail-deleted-row" style="display: none;">
                                        <span class="text-danger d-block font-weight-bold">Dihapus Pada (Recycle Bin):</span>
                                        <div id="detail-deleted-at">-</div>
                                    </li>
                                    <li class="list-group-item px-0 py-2" id="detail-restored-row" style="display: none;">
                                        <span class="text-success d-block font-weight-bold">Dipulihkan Pada:</span>
                                        <div id="detail-restored-at">-</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="modal-footer bg-white d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-info btn-sm font-weight-bold" id="btn-edit-from-detail">
                    <i class="fas fa-edit mr-1"></i> Edit Pengguna Ini
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            <form id="form-edit-user">
                ...
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title font-weight-bold"><i class="fas fa-edit mr-1"></i> Edit Pengguna</h5>
                    <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="row">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-info text-white"><i class="fas fa-save mr-1"></i> Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
...
$this->registerJs(<<<JS
    ...
    const devDefaultPreset = "{$defaultRangeConfig}";
    ...
    $('#modal-create, #modal-edit').on('shown.bs.modal', function () {
    ...
    // Helper Formatter Tanggal UTC -> Waktu Lokal Klien
    function renderDateTimeWithRelative(utcString) {
        ...
        return `
            ...
            <div class="text-nowrap text-muted small mt-1">
                <i class="far fa-clock text-secondary mr-1"></i>\${formattedTime} <span class="badge badge-light border">(\${rel})</span>
            </div>
        `;
    }
    ...
    const usersTable = $('#table-users').DataTable({
        ...
        language: {
            processing: '<i class="fa fa-spinner fa-spin fa-2x fa-fw text-primary"></i> Memproses Data Server...',
    ...
    setDefaultDateFilter(devDefaultPreset);
    ...
    $('#btn-toggle-trash').on('click', function() {
        ...
        if (isTrashMode === 0) {
            ...
            $('#page-heading').text('Recycle Bin (Data Terhapus)');
            ...
            $('#page-heading').text('Manajemen Pengguna');
    ...
    // ================= 1. EVENT HANDLER TOMBOL DETAIL LENGKAP (<i class="fas fa-eye"></i>) =================
    $(document).on('click', '.btn-detail', function() {
        const id = $(this).data('id');
        currentDetailUserId = id;

        $.ajax({
            url: '{$viewDataUrl}?id=' + id,
            type: 'GET',
            dataType: 'json',
            success: function(res) {
                if (res.status === 'success') {
                    ...
                    // Audit Trail Waktu (Dikonversi ke lokal)
                    $('#detail-registered-at').html(renderDateTimeWithRelative(d.registered_at));
                    $('#detail-modified-at').html(d.modified_at ? renderDateTimeWithRelative(d.modified_at) : '<span class="text-muted">- Belum pernah diubah -</span>');

                    // Baris Deleted / Restored (Jika ada)
                    if (d.deleted_at) {
                        $('#detail-deleted-row').show();
                        $('#detail-deleted-at').html(renderDateTimeWithRelative(d.deleted_at));
                    } else {
                        $('#detail-deleted-row').hide();
                    }

                    if (d.restored_at) {
                        $('#detail-restored-row').show();
                        $('#detail-restored-at').html(renderDateTimeWithRelative(d.restored_at));
                    } else {
                        $('#detail-restored-row').hide();
                    }
    ...
    // Shortcut Edit dari Modal Detail
    ...
    $('#btn-bulk-delete').on('click', function() {
        ...
        Swal.fire({
            ...
            text: 'Semua data yang dipilih akan disembunyikan dan dapat dipulihkan nanti.',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#ffc107',
            cancelButtonColor: '#6c757d',
            confirmButtonText: `<i class="fas fa-trash"></i> Ya, Pindahkan \${ids.length} Data!`,
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status === 'success') {
                            ...
                            updateBulkToolbar();
                            usersTable.ajax.reload(null, false);
                            toastr.warning(res.message, 'Bulk Soft-Delete Berhasil');
                        }
                    }
                });
            }
    ...
    $('#btn-bulk-restore').on('click', function() {
        ...
        Swal.fire({
            ...
            text: 'Semua data terpilih akan dikembalikan ke daftar pengguna aktif.',
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#28a745',
            cancelButtonColor: '#6c757d',
            confirmButtonText: `<i class="fas fa-trash-restore"></i> Ya, Pulihkan!`,
            cancelButtonText: 'Batal'
        }).then((result) => {
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status === 'success') {
                            ...
                            updateBulkToolbar();
                            usersTable.ajax.reload(null, false);
                            toastr.success(res.message, 'Bulk Restore Berhasil');
                        }
                    }
                });
            }
    ...
    $('#btn-bulk-force-delete, #btn-bulk-force-delete-trash').on('click', function() {
        ...
        Swal.fire({
            ...
            html: `<b>PERINGATAN!</b> \${ids.length} data ini akan <b>DIHAPUS TOTAL</b> dari database!`,
            icon: 'error',
            showCancelButton: true,
            confirmButtonColor: '#d33',
            cancelButtonColor: '#6c757d',
            confirmButtonText: `<i class="fas fa-skull-crossbones"></i> Hapus Permanen!`,
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status === 'success') {
                            ...
                            updateBulkToolbar();
                            usersTable.ajax.reload(null, false);
                            toastr.error(res.message, 'Bulk Destroy Selesai');
                        }
                    }
                });
            }
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.status === 'success') {
                    ...
                    toastr.error(Object.values(res.errors).join('<br>'), 'Gagal!');
                }
            }
        });
    });
    ...
    $(document).on('click', '.btn-delete', function() {
        ...
        Swal.fire({
            ...
            text: 'Data pengguna ini akan disembunyikan dan dapat dipulihkan nanti.',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#ffc107',
            cancelButtonColor: '#6c757d',
            confirmButtonText: '<i class="fas fa-trash"></i> Ya, Pindahkan!',
            cancelButtonText: 'Batal'
        }).then((result) => {
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status === 'success') {
                            ...
                            updateBulkToolbar();
                            usersTable.ajax.reload(null, false);
                            toastr.warning(res.message, 'Soft Deleted');
                        }
                    }
                });
            }
    ...
    $(document).on('click', '.btn-restore', function() {
        ...
        Swal.fire({
            ...
            confirmButtonColor: '#28a745',
            cancelButtonColor: '#6c757d',
            confirmButtonText: '<i class="fas fa-trash-restore"></i> Pulihkan',
            cancelButtonText: 'Batal'
        }).then((result) => {
            if (result.isConfirmed) {
                $.ajax({
                    url: '{$restoreUrl}?id=' + id,
                    type: 'POST',
                    dataType: 'json',
                    success: function(res) {
                        if (res.status === 'success') {
                            ...
                            updateBulkToolbar();
                            usersTable.ajax.reload(null, false);
                            toastr.success(res.message, 'Dipulihkan');
                        }
                    }
                });
            }
    ...
    $(document).on('click', '.btn-force-delete', function() {
        ...
        Swal.fire({
            ...
            html: 'PERINGATAN! Data akan <b>DIHAPUS TOTAL</b> dari database!',
            icon: 'error',
            showCancelButton: true,
            confirmButtonColor: '#d33',
            cancelButtonColor: '#6c757d',
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status === 'success') {
                            ...
                            updateBulkToolbar();
                            usersTable.ajax.reload(null, false);
                            toastr.error(res.message, 'Terhapus Permanen');
                        }
                    }
                });
            }
